...
var zombie1Img,zombie2Img,zombie3Img,zombie4Img,info,infoimg,start,startimg,name1,name1img;
var life=3;
var Score=0;
var gamestate="start";
...
function preload(){
  name1img=loadImage("assets/download.jpg")
...
function setup() {
  ...
  name1=createSprite(400,180)
  name1.addImage(name1img);
  name1.visible=false;
